            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div>
                    <div className='flex-1 flex flex-col gap-1'>
                        ...
                        <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' type="number" placeholder='write about doctor' rows={5} required />
                    </div>
